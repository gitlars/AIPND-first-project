...
from add_summary_results import add_summary_results
from print_summary_results import print_summary_results
...
def main():
    ...
    # Add to summary results to dictionary/file of all results of calls to this program
    add_summary_results(results_stats, in_arg.dir, in_arg.arch, tot_time)

    # Print out a summary of all latest results achieved
