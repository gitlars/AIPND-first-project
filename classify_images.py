...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
        ...
        abs_path = path.abspath(images_dir) + "/" + key
        
        imagenet_classes_dict[key] = classifier(abs_path, model)

        classifier_string = imagenet_classes_dict[key].lower().strip()
        classifier_labels = classifier_string.lower().split(", ")

        results_dic[key].append(classifier_string)
        ...
        if results_dic[key][0] in classifier_labels:
